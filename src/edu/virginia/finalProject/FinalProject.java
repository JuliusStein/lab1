...
public class FinalProject extends Game{
    ...
    static Piece p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, bomb, battery;
	...
	private static void populateLevel(int level) 
	{
		...
		{	
            ...
            p10 = new Piece("botRight3", "BottomRight.png", 5, 1, 0, 0);
            p10.setPosition(new Point(331, 463));
            p10.setStartingPosition(new Point(331, 463));
            p10.setMovable(true);
            addPieceAtIndex(p10, 9);
            p11 = new Piece("topLeft3", "TopLeft.png", -5, -1, 0, 0);
            p11.setPosition(new Point(477, 463));
            p11.setStartingPosition(new Point(477, 463));
            p11.setMovable(true);
            addPieceAtIndex(p11, 10);
            p12 = new Piece("horizontalResistor2", "resistorHorizontal10.png", -1, 1, 0, 10);
            p12.setPosition(new Point(185, 609));
            p12.setStartingPosition(new Point(185, 463));
            p12.setMovable(true);
            addPieceAtIndex(p12, 11);
        }
		else if (level == 3)
		{
			...
			p9.setMovable(true);
			addPieceAtIndex(p9, 8);
            p10 = new Piece("botLeft3", "BottomLeft.png", 5, -1, 0, 0);
            p10.setPosition(new Point(185, 463));
            p10.setStartingPosition(new Point(185, 463));
            p10.setMovable(true);
            addPieceAtIndex(p10, 9);
            p16 = new Piece("verticalResistor5_2", "resistorVertical5.png", -5, 5, 0, 5);
            p16.setPosition(new Point(331, 463));
            p16.setStartingPosition(new Point(331, 463));
            p16.setMovable(true);
            addPieceAtIndex(p16, 10);
            p17 = new Piece("topLeft3", "TopLeft.png", -5, -1, 0, 0);
            p17.setPosition(new Point(477, 463));
            p17.setStartingPosition(new Point(477, 463));
            p17.setMovable(true);
            addPieceAtIndex(p17, 11);
            p18 = new Piece("horizontalWire3", "Horizontal.png", -1, 1, 0, 0);
            p18.setPosition(new Point(185, 609));
            p18.setStartingPosition(new Point(185, 609));
            p18.setMovable(true);
            addPieceAtIndex(p18, 12);
