...
public class LabFiveGame extends Game{
	 ...
	 * */
	public LabFiveGame() {
		super("Lab Five Test Game", 1000, 300);
	}
	...
	public void update(ArrayList<Integer> pressedKeys){
		...
		if (mario.isCollision()){
			if(mario.getBounceTimer()>10){
				mario.setPosition(new Point(mario.getPosition().x+(10*mario.getFacing()), mario.getPosition().y-10));
				mario.setPivotPoint(new Point(mario.getPivotPoint().x+(10*mario.getFacing()), mario.getPivotPoint().y - 10));
				mario.setBounceTimer(mario.getBounceTimer()-1);
			}else if(mario.getBounceTimer()>0){
				mario.setPosition(new Point(mario.getPosition().x+(10*mario.getFacing()), mario.getPosition().y+10));
				mario.setPivotPoint(new Point(mario.getPivotPoint().x+(10*mario.getFacing()), mario.getPivotPoint().y + 10));
				mario.setBounceTimer(mario.getBounceTimer()-1);
			}else{
